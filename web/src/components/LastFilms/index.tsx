...
export function LastFilms() {
    return (
        <div className="bg-zinc-800 h-full w-56 flex flex-col items-center fixed right-0 gap-8 px-4 py-8 mr-1 border-x-[1px] border-x-zinc-600 overflow-y-scroll scrollbar-thumb-zinc-600 scrollbar-track-transparent scrollbar-thin">
